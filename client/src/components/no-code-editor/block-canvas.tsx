...
export function BlockCanvas({
  ...
  }, [selectedBlockId, onDeleteBlock, onSelectBlock]);
  ...
  return (
    ...
    >
            ...
            >
              ...
              <div className="absolute left-0 top-0 bottom-0 flex items-start pt-5">
                <button
                  ...
                  className={cn(
                    "w-3 h-3 rounded-full border-2 bg-white transition-all",
                    connectingFrom ? "border-green-500 hover:scale-125" : "border-gray-400 hover:border-blue-500"
                  )}
              ...
              <div className="absolute right-0 top-0 bottom-0 flex items-start pt-5">
                <button
                  ...
                  className={cn(
                    "w-3 h-3 rounded-full border-2 bg-white transition-all",
                    connectingFrom === block.id ? "border-green-500 scale-125" : "border-gray-400 hover:border-blue-500"
                  )}
      ...
      {selectedBlockType && !dragging && (
        ...
        >
          <div className="rounded-xl border-2 border-dashed border-primary bg-white/50 p-3">
